...
class MyGame(arcade.Window):
    ...
    def on_mouse_press(self, x, y, button, modifiers):
        ...
        print(f"Total of {count} cells selected.")
        ...
        for row in range(ROW_COUNT):
            ...
            if continuous_count > 2:
                ...
                continuous_count = 0
            print(f"Row {row} has {row_count} cells selected.")
        ...
        for row in range(COLUMN_COUNT):
            ...
            for column in range(ROW_COUNT):
                if self.grid[row][column] == 1:
                    ...
                    continuous_count += 1
            if continuous_count > 2:
                print(f"There are {continuous_count} continuous blocks selected on column {column}.")
                continuous_count = 0
            print(f"Column {column} has {column_count} cells selected.")
